            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="dashboard-stat blue">
                        ...
                        <a class="more" href="#" id="visualizaClientes">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green">
                        ...
                        <a class="more" href="#" id="visualizaUsuarios">
                            Visualizar <i class="m-icon-swapright m-icon-white"></i>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple">
                        ...
                        <a class="more" href="#" id="visualizaFornecedores">
                            Visualizar <i class="m-icon-swapright m-icon-white"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet box grey">
                        ...
                        <div class="portlet-body" id="tabeladash">
